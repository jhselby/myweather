...
STATIONS = [
    ...
    "KMAMARBL56", "KMAMARBL78", "KMASALEM94",
...
# for these stations every tick. Station IDs are still valid in WU's directory
# (the wunderground.com page resolves), but the owners aren't uploading recent
# observations. Confirmed via direct API probe of all 60 stations.
# If a culled station comes back online later, re-add it to STATIONS above.
CULLED_STATIONS = [
    "KMAMARBL89",  "KMAMARBL117", "KMAMARBL118", "KMAMARBL17",
    "KMAMARBL26",  "KMAMARBL84",  "KMASALEM35",  "KMASALEM86",
    "KMASALEM111", "KMASWAMP28",
