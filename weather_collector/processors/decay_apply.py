...
L3_FIELDS = {"wg", "ch"}  # cm dropped 2026-09-15 v0.6.625 after walkforward_l3l4_validator cleared 7-day gate on this proposal (L3 fc -1.6% / obs -1.2% pooled; only calm/24-47h shows LOSS -17.2%, no regime × band cell reaches WIN — no positive to preserve). ws dropped 2026-08-08 v0.6.397 (ws L3 fc +0.1% / obs +0.6% pooled — noise, no field-level signal after the ne_flow + sea_breeze skips already in the SKIP_TABLE). pp dropped 2026-07-04 v0.6.304 after audit reconciliation: Fitter Brier l1=0.0734→l3=0.0765 (WORSE +4.2%), production_whatif +87.3% WORSE, h_regime_l3 pp sea_breeze L3 LOSES -96%.
L4_FIELDS = {"ch", "wg"}  # wg added 2026-09-24 v0.7.1 after walkforward_l3l4_validator cleared 7-day claim gate (L4 fitter both views +27.4%/+27.3%, 0 entangled). cc dropped 2026-08-28 v0.6.515 after walkforward_l3l4_validator cleared 7-day drop gate (cc is Ccd-overwritten downstream — cc_from_derivation.py runs after L4 and replaces cloud_cover with max(cl_l6, cm_l6, ch_l6) except SKIP_REGIMES). L4 cc correction was code-hygiene deadweight; no user-visible change.
