## v0.5.201–v0.5.224 • May 30, 2026
* **Frontend split (v0.5.224):** pressure-alarm banner + storm-mode composite badge logic (~60 lines) extracted from `app-main.js` into `js/alarms.js` as `renderPressureAlarm(data)` + `renderStormMode(data)`. app-main.js 1,513 → 1,453 lines.
