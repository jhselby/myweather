## v0.5.201–v0.5.221 • May 30, 2026
* **Frontend split (v0.5.221):** version-update detection + refresh-on-return (~78 lines) extracted from `app-main.js` into a new `js/version_check.js` module. app-main.js 1,654 → 1,576 lines.
